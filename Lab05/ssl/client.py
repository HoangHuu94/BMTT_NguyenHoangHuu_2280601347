...
context.verify_mode = ssl.CERT_NONE         # Tắt xác minh chứng chỉ (chỉ dùng trong môi trường test)
context.check_hostname = False              # Tắt kiểm tra hostname (nên bật trong môi trường thực tế)
